...
public class RmThree {
	...
	private static void receive() {
		...
		try {
			...
			System.out.println("RM3 UDP Server "+PortsAndIPs.RM_Group_PortNum+" Started............");
    ...
    private static void receiveFeedback() {
		...
		try {
			...
			byte[] buffer = new byte[1000];
			System.out.println("RM3 receive feedbacks at port :"+PortsAndIPs.RM_Feedback_Portnum );
